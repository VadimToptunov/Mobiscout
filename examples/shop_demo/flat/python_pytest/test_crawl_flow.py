...
def test_path_1_2_3_4(driver):
    ...
    driver.activate_app("com.example.shop")
    # Type into Email
    _find(driver, (AppiumBy.ACCESSIBILITY_ID, "Email"), [(AppiumBy.ID, "com.example.shop:id/email")]).send_keys("test@example.com")
    # Type into Password
    _find(driver, (AppiumBy.ACCESSIBILITY_ID, "Password"), [(AppiumBy.ID, "com.example.shop:id/password")]).send_keys("Password123!")
    # Toggle Remember me
    ...
    _find(driver, (AppiumBy.ACCESSIBILITY_ID, "Search products"), [(AppiumBy.ID, "com.example.shop:id/search")]).send_keys("test")
    # Tap Running Shoes
